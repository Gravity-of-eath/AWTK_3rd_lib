...
/* Cooperative stop hook: let the AWTK glue abort the Cycle() loop mid-frame
 * so nes_runtime_stop joins without waiting up to a full frame.
 * Declared at file scope — extern "C" is not allowed inside a function body. */
